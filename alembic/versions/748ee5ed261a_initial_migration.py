...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_user_feed_item_states_id"), "user_feed_item_states", ["id"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_subscriptions_source_id"), "subscriptions", ["source_id"], unique=False
    )
