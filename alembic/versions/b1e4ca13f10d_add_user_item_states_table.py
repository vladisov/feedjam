...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_user_item_states_user_item",
        "user_item_states",
        ["user_id", "feed_item_id"],
        unique=True,
    )
    op.create_index(
        "ix_user_item_states_user_liked", "user_item_states", ["user_id", "liked"], unique=False
    )
    op.create_index(
        "ix_user_item_states_user_read", "user_item_states", ["user_id", "read"], unique=False
    )
    op.create_index(
        "ix_user_item_states_user_starred", "user_item_states", ["user_id", "starred"], unique=False
    )
